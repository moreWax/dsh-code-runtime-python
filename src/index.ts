...
export const name = 'code-runtime-python-uv'
...
const PYTHON_PROJECT = fileURLToPath(new URL('../python', import.meta.url))
const BOOTSTRAP = fileURLToPath(new URL('../python/bootstrap.py', import.meta.url))
